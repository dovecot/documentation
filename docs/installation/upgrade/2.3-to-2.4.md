...
For configuration conversion assistance, we provide https://dovecot.org/upgrader/ that can be used to convert your 2.3 configuration into 2.4.
...
<!-- @include: include/2.4-lazy-expunge.inc -->
