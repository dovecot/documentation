...
| Setting | Old Default Value | New Default Value |
| ------- | ----------------- | ----------------- |
| [[setting,@metric_defaults]]`/proxy/metric` |  | Adds proxy_session_established |
...
| [[setting,@mailbox_defaults]]`/english/namespace/inbox/mailbox/Drafts/mailbox_auto` | `no` | `subscribe` |
| [[setting,@mailbox_defaults]]`/english/namespace/inbox/mailbox/Junk/mailbox_auto` | `no` | `subscribe` |
| [[setting,@mailbox_defaults]]`/english/namespace/inbox/mailbox/Sent/mailbox_auto` | `no` | `subscribe` |
| [[setting,@mailbox_defaults]]`/english/namespace/inbox/mailbox/Trash/mailbox_auto` | `no` | `subscribe` |
...
<!-- @include: include/2.4.6-cassandra-settings.inc -->
