...
const normalizedPath = computed(() => {
  ...
  // Strip the site base to get the relative path
...
<template>
  <div ref="container" class="VPLlmsPageActions">
    <button
      class="trigger"
      type="button"
      aria-haspopup="menu"
    ...
    >
      ...
      <span class="trigger-label">Markdown</span>
      <svg
        aria-hidden="true"
        class="trigger-caret"
        viewBox="0 0 16 16"
    ...
    <Transition name="menu">
      <div v-if="open" class="menu" role="menu">
        ...
        <div
          v-if="hasLlmsTxt || hasLlmsFullTxt"
          class="menu-divider"
          aria-hidden="true"
        ></div>
