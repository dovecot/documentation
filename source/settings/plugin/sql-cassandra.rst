...
For read consistency following values are supported
---------------------------------------------------
...
For write and delete consistency following values are supported
---------------------------------------------------------------
...
``each-quorum``
  A write must be written to the commit log and memoryt table on a quorum of replica nodes in each datacenter.
