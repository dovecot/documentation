...
agent <https://wiki2.dovecot.org/MDA#>`_, which takes mail from an
`MTA <https://wiki2.dovecot.org/MTA#>`_ and delivers it to a user's
mailbox, while keeping Dovecot index files up to date. Nowadays you
should probably use the `LMTP
server <https://wiki2.dovecot.org/LMTP#>`_ instead, because it's
...
-  `LDA/Postfix <https://wiki2.dovecot.org/LDA/Postfix#>`_

-  `LDA/Exim <https://wiki2.dovecot.org/LDA/Exim#>`_

-  `LDA/Sendmail <https://wiki2.dovecot.org/LDA/Sendmail#>`_

-  `LDA/Qmail <https://wiki2.dovecot.org/LDA/Qmail#>`_

-  `LDA/ZMailer <https://wiki2.dovecot.org/LDA/ZMailer#>`_

Main features of Dovecot LDA
----------------------------

-  `Mailbox indexing during mail
   delivery <https://wiki2.dovecot.org/LDA/Indexing#>`_, providing
...
-  If you have trouble finding where Dovecot logs by default, see
   `Logging <https://wiki2.dovecot.org/Logging#>`_.
...
-  Most of the `Dovecot
   plugins <https://wiki2.dovecot.org/Plugins#>`_ work with
   dovecot-lda.
